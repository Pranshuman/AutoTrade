    ...
    try {
        ...
        if (data.credentials) {
            ...
            if (data.tokenValid) {
                ...
                statusBadge.textContent = '⚠ Access Token Expired - Please Re-authenticate';
                ...
                if (errorDiv) {
                    errorDiv.textContent = 'Your access token has expired. Please click "Generate Access Token" to re-authenticate.';
                    errorDiv.classList.add('show');
                }
            }
